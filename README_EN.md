...
- Runtime input and output: `PiGraphContext`, `PiGraphContextBinder`, `PiEngineFrame`
- Structured graph results: `PiGraphResult`, `PiActionResult`, `PiDebugFrame`
...
Current version: `com.mihono.pickaid:pidatagraph:0.0.6`
